...
var createList []func() error

func AddCreateFileDir(fun func() error) {
	createList = append(createList, fun)
}

func writeApplicationYml() error {
	return nil
}

func writeFileList() error {
	return nil
}

func writeFilesDir() error {
	return nil
}

func writeIconsDir() error {
	return nil
}

func packageJson() error {
	return nil
}

func writeScreeenshotsDir() error {
	return nil
}
